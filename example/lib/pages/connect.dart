  ...
  Future<void> _readPrefs() async {
    ...
    _uriCtrl.text = const bool.hasEnvironment('URL')
        ...
        : prefs.getString(_storeKeyUri) ??
            'wss://shush-chat-ykzlognz.livekit.cloud';
    _tokenCtrl.text = const bool.hasEnvironment('TOKEN')
        ? const String.fromEnvironment('TOKEN')
        : prefs.getString(_storeKeyToken) ??
            (Platform.isAndroid
                ? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..SKtmYzVING5cALCtgDU1cggka9S5d7VkpqseyaUNPHc'
                : Platform.isIOS
                    ? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..pj7NI5Pfj5eMZe-iLXQrbb4Mx_oxK-cEO5TP-Vnvf9s'
                    : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..djXGBkqegR4wHTwyfqhGeLi9FmuLVezkjaK4yutcaq8');
